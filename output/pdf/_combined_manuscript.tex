...
\pandocbounded{\includegraphics[keepaspectratio,alt={Subfield distribution for Modafinil. The 6-bucket taxonomy shows the relative weight of each configured sub-area, with Clinical Sleep dominant at 64.3\%.}]{../figures/subfield_distribution.png}}\{\{\#fig:subfield\_distribution\}\}
